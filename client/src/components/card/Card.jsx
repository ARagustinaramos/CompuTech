...
const Card = ({ id_Product, name, image, price }) => {
  ...
  return (
    <div key={id_Product} className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <Link to={`/detail/${id_Product}`} key={id_Product}>
