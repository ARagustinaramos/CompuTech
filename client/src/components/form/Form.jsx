						...
						<form onSubmit={handleSave}>
							...
							<div className="mb-4">
								...
								<textarea
									...
									onChange={handleChange}
									className={`mt-1 p-2 w-full border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500 h-32 resize-none overflow-y-auto focus:outline-none dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 ${
