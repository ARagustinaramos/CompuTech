...
const Cart = () => {
    const [nextId, setNextId] = useState(1); // Estado para almacenar el próximo id
                                        ...
                                        <div className="space-y-4 md:flex md:items-center md:justify-between md:gap-6 md:space-y-0">
                                            ...
                                            <div className="flex items-center justify-between md:order-3 md:justify-end">
                                                <div className="flex items-center">
                                                    ...
                                                    <input
                                                        ...
                                                        onChange={(e) => handleQuantityChange(e, item.id)} // Controlador onChange
                                                        required
                                                    />
                                            ...
                                            <div className="w-full min-w-0 flex-1 space-y-4 md:order-2 md:max-w-md">
                                                ...
                                                <div className="flex items-center gap-4">
                                                    ...
                                                    <button onClick={() => handleRemoveItemClick(item.id_Product)} type="button" className="inline-flex items-center text-sm font-medium text-red-600 hover:underline dark:text-red-500">
                                                        <svg className="me-1.5 h-5 w-5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                ...
                <div className="space-y-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <dl className="flex items-center justify-between gap-4 border-t border-gray-200 pt-2 dark:border-gray-700">
                            ...
                            <dd className="text-base font-bold text-gray-900 dark:text-white">{/* Aquí iría el total del pedido */}</dd>
                        </dl>
                    </div>
