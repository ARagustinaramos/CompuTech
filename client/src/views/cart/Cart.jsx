            ...
            <section className="bg-white py-8 antialiased dark:bg-gray-900 md:py-16 w-full">
                ...
                {cartItems.length === 0 ? (
                    <div className="flex flex-col items-center justify-center mt-6 sm:mt-8">
                        ...
                        <p className="text-2xl font-bold text-gray-900 dark:text-gray-400">El carrito está vacío</p>
                    ...
                    <div className="mx-auto mt-6 sm:mt-8 md:gap-6 lg:flex lg:items-start xl:gap-8">
