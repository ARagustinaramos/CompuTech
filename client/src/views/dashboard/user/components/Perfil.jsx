        ...
        const unsubscribe = auth.onAuthStateChanged((user) => {
            if (user) {
                ...
                setPerfilInfo({
                    ...
                    address: '', // Ajusta según tus datos
                    phoneNumber: user.phoneNumber || '',
                    email: user.email || '',
                    image: user.image  || 'https://res.cloudinary.com/damfsltm2/image/upload/v1716826731/Computech-Products/favicon_chnb9k.png'
                });
                setIsLoading(false);
            } else {
                ...
                <div className="grid grid-cols-1 mt-10 gap-8 lg:grid-cols-1">
                    <form className="p-8 rounded-xl shadow-2xl mb-8 flex flex-col dark:bg-gray-800 md:py-5">
                        ...
                        <div className='pb-6 flex items-center justify-around'>
                            <img src={perfilInfo.photoURL || 'https://static.vecteezy.com/system/resources/previews/005/337/799/non_2x/icon-image-not-found-free-vector.jpg'} className="w-20 h-20 object-cover rounded-full ring-2 ring-gray-300" />
                            {
                        ...
                        <div className="grid mb-6 md:grid-cols-1 lg:grid-cols-1">
                            <label>{perfilInfo.name || 'Nombre de usuario'}</label>
                            {
                            ...
                            <label>{perfilInfo.address || <p className='text-red-500 font-bold'>'Ingresa una dirección de envío'</p>}</label>
                            {
                            ...
                            <label>{perfilInfo.email || <p className='text-red-500 font-bold'>'Ingresa un correo'</p>}</label>
                            {
                            ...
                            <label>{perfilInfo.phoneNumber || <p className='text-red-500 font-bold'>'Ingresa un número de teléfono'</p>}</label>
                            {
