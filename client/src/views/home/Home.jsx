...
const Home = () => {
	...
	const toShow =
		filteredProducts.length > 0
			? filteredProducts.filter((product) => product.active)
			: activeProducts;
			...
			<Flowbite>
				<div className="bg-white antialiased dark:bg-gray-900 md:py-5">
					<div className="pt-16">
						...
						<div className="flex overflow-x-auto sm:justify-center mb-2 space-x-4">
							{" "}
							{/* Añadido espacio horizontal */}
						...
						<Cards products={toShow} filterApplied={filterApplied} />
					</div>
				</div>
			</Flowbite>
		</>
