...
const Detail = () => {
  ...
  return (
    ...
    <section className="text-gray-700 body-font overflow-hidden  bg-white py-8 antialiased dark:bg-gray-900 md:py-16">
      <div className="container px-5 py-24 mx-auto">
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
          <img alt="ecommerce" className="lg:w-1/2 w-full object-cover object-center rounded border border-gray-200" src={pokemon.imagen} />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
            <h2 className="text-sm title-font text-gray-500 tracking-widest">BRAND NAME</h2>
            <h1 className="text-gray-900 text-3xl title-font font-medium mb-1">{pokemon.nombre}</h1>
            ...
            <div className="flex">
              ...
              <button className="flex ml-auto text-white  bg-blue-700 hover:bg-blue-800 border-0 py-2 px-6 focus:outline-none rounded">Button</button>
